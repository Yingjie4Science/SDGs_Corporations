...
### ag_ls ----
ag_ls = "agricultur|\\bagro|agronom|agrarian|\\bcrop|food|farm|forestry|pastoral|pasture|\\bfisher|horticulture|cultivation|husbandry|grazing|\\bgrain|planting|\\btillage|\\btilling"


### child_ls ----
child_ls = paste("child|\\bteen|juvenile|youth|young|\\bminor.?\\b|under 5|under five|underfive|before fifth|adolescen",
...
### disability_ls ----
disability_ls = "Disabled|disabilit|handicapped|incapacitated|crippled|\\bblind\\b"
...
### equal_ls ----
equal_ls = "equal|\\bequitab|\\bequality|\\bunbias|unprejudic|\\bfair|impartial"


### discrimination_ls ----
discrimination_ls = "discrimin|\\bbias|prejudice|\\bunfair|inequal|inequit|disparit|imparit"
...
increase_ls = paste("accelerat|ascend|\\badvanc|augment|\\bamplif|magnif|burgeon|\\bclimb|better|boost|\\bboom|\\bdouble|escalat",
                    ...
                    "increas|foster|\\bfortif|facilitat|increment|jump|\\blift|\\brais|\\brise.?\\b|rising|\\brose|risen|\\brocket|skyrocket",
...
### LGBT_ls ----
LGBT_ls = "\\bLGBT|\\blesbian|\\bgay\\b|bisexual|transgender|\\bQueer\\b|Questioning|Intersex|\\bAllies\\b|\\bAsexual\\b|Pansexual"
...
renewable_ls_y = paste("(\\brenewables|biofuel|bioenergy|biodiesel|biogas|bioethanol|hydropower", 
                       "hydroelectric|electrofuel|\\be.?fuel|photovoltaic|wind farm|offshore wind|wind turbine|solar panel)", sep = "|")
...
### finance_ls ----
finance_ls <- paste("financ|\\bfund.?\\b|\\bfunding\\b|\\bassist|budget|\\baid.? to",
...
### support_ls ----
support_ls  = paste("financ|\\bfund.?\\b|\\bfunding\\b|\\bassist|budget|\\baid.? to",
                    "government aid.?\\b|state aid.?\\b|federal aid|national aid", 
                    "invest|compensation|donor|donat",
                    "help|enhanc|expenditure|\\bgrant.?\\b|\\bloan.?\\b|official flow|support|\\bsubsidy|\\bsubsidies|\\bsubsidiz|\\bsubsidis",
                    "\\bstimulat|strengthen|\\bfortif|transfer|uphold|boost|bolster", sep = "|")
...
SDG2_1_y = c(reduce_ls, "food|nutrition", "insecurity|desert.?\\b|deprivation|deficien")
...
SDG2_4_x = c(ag_ls, 
             "sustain|resilien|productiv|\\borganic|ecological")
SDG2_4_y = c(ag_ls,
             "adapt", 
...
SDG2_5_x = c("genetic",
             "manag|maintain|diversif|diversity|conserv|secur", 
             "cultivated|farmed|domesticated",
             "seed|plant bank|animal|wild species")
SDG2_5_y = c("manag|maintain|diversif|diversity|conserv|secur|\\butiliz",
             "local|\\btraditional\\b|indigen|aboriginal|native|endemic", 
             "breed|bred")
SDG2_5_z = c("genetically modified|\\bGMO\\b", 
             "food|agricultur")


SDG2_a_x = c(paste(support_ls, "\\badvanc|cooperat|collaborat|joint effort|\\bflow\\b|\\bflows\\b", sep = '|'), 
             "rural|agricult",
             "infrastructure|research|investig|extension.?\\b|technolog") 
SDG2_a_y = c(paste(support_ls, "\\badvanc|cooperat|collaborat|joint effort|\\bflow\\b|\\bflows\\b", sep = '|'), 
             "\\bplant|\\bsoy|livestock|animal|cattle|\\bcow|\\bpig|sheep|\\bhog|horse|oxen|\\bherd|swine", 
             "gene bank")
...
SDG3_5 = c("substance|drug|alcohol|drinking|drunk|ethanol|liquor|liqueur|booze|\\bwine|\\bbeer|Narcotic", 
           "\\babus|misuse|misconduct|obsessive|addict|\\bharm.?\\b|\\bharmed\\b|hazardous|disorder",
           paste('\\btreatment', reduce_ls, sep = "|"))

SDG3_6_x = c(
  paste("\\broad.?\\b|\\broadway|\\blane|avenue|street|\\bdrive\\b|\\bcar\\b|automobile|\\bmotor|vehicle",
        "highway|expressway|freeway|\\brail|congest|collision|collid|\\bjam|traffic|transport.?\\b|transportation|\\btransit.?\\b|travel", 
        sep = "|"),
  paste(death_ls,
        "fatal|injur|accident|adversit|bottleneck|damag|wound|catastroph|calamit|casualt|crash|disaster",
        "\\bharm.?\\b|\\bharmed\\b|hazard|emergenc|traged", 
        sep = "|"))
SDG3_6_y = "\\bTZD program|\\bTZD National Strategy|\\bTZD Strateg|Toward Zero Deaths|Road to Zero"
...
SDG3_b_x = c(
  paste("vaccin|medicin|medication|antibiotic|pharmac", "health facilit|health sector", sep = '|'),
  "research|develop|\\bR&D\\b",
  developing_country_ls,
  support_ls)
SDG3_b_y = c(
  paste("vaccin|medicin|medication|antibiotic|pharmac", "health facilit", sep = '|'),
  "access|\\bavailab|afford|covered by|TRIPS Agreement|Trade.?Related Aspects of Intellectual Property Rights")
...
SDG3_c_x = c("\\bhealth\\b|well.?being", 
             "financ[a-z]*|\\bfund.?\\b|\\bfunding\\b|\\bassistance|\\baid.? to|government aid|state aid|federal aid|national aid|invest|donor|donat|\\bgrant.?\\b|official flow")
temp <- SDG3_c_x
ex_ls  <- c('statement', 'granted', 'investigat', 'financial assumption', 'finance corporation', 
...
SDG4_1_x1 = c(child_ls, 
              ...
              "educat|school",
              "\\bcomplet|conclud|\\bend\\b|\\bfinish|Finaliz|\\bFulfill|accomplish|\\bachiev|wrap up")
...
SDG4_2_x = c(paste(child_ls, "infant|toddler", sep = "|"),
             "\\bcare.?\\b|pre.?primary educat|health|well.?being|psycho") 
...
SDG4_3_x <- c("technical|vocational|tertiary", 
              "educat|\\bcollege.?\\b|universit|\\btraining|learning|high school",
              temp)
...
SDG4_5 = c(
  ...
  paste(disability_ls,
        "wounded|indigen|aboriginal|vulnerable|\\bgender|female|women|rural", 
...
SDG4_7_x = c("\\bknowledge|skill|educat|\\btraining|curricula|teach|student assessment",
             "sustainable development|sustainable lifestyle|human right|\\bethics|gender equality|peace|non.?violence|cultural diversity")
...
SDG4_b = c(paste("scholarship|fellowship|official development assistance", 
                 "financ|\\bfund.?\\b|\\bfunding\\b|\\baid.? to|government aid.?\\b|state aid.?\\b|invest|\\bgrant.?\\b|official flow", 
                 sep = "|"),  
...
SDG5_b = c("technolog|information|communications|mobile.?phone|telephone|smart.?phone|Cell.?phone|\\bICT\\b",
           "\\bempower|promot",
           female_ls)	
...
SDG6_4_x = c("\\bwater\\b|freshwater|groundwater", 
             "\\befficien|sustainab|secur|availab|conservat|recycl|\\bre.?us|adequate|abundan|plentiful|plentiful|sufficient")
SDG6_4_y = c("\\bwater\\b|freshwater|groundwater",
             "footprint|\\bgreen\\b|blue|grey|scarcity|scarce|scant|shortage|\\bstress|dearth|deficit|\\black|shortfall|insufficien|inadequa|deficienc",
...
SDG6_6 = c("\\bwater\\b|mountain|forest|wetland|river|aquifer|lake",
           "eco.?system",
           "conserv|\\brestor|reserv|mainten|protect|preserv|safeguard")
...
SDG6_a_y = c("\\bwater\\b|sanita",
             "international co.?op|international collab",
             developing_country_ls)
...
SDG6_b =  c("\\bwater\\b|sanita", 
            "\\blocal communit|local administrat|regional|resident|indigen|aboriginal|\\btraditional\\b|native|endemic",
            # paste(support_ls, increase_ls, sep = "|"),
            paste("participat", policy_ls, sep = "|"))
...
SDG7_1_x = c(paste('energy|\\bfuel|\\bpower\\b', "electricity", sep = "|"), 
             "reliable|affordab|modern|\\clean\\b|sustainable",
             "access|availab")
SDG7_1_y = "Power outage"


SDG7_2_w = c(renewable_ls, 
             paste("\\bshare|proportion|\\bpercent|\\bmix\\b|consum|transiti|shift", increase_ls, sep = "|"))
### Option 1: use `func_AND_plus` function
...
SDG7_3_x = c("energy|\\belectric|\\bfuel|\\bpower\\b|\\butilit",
             "\\befficien|\\bintens|pollut|footprint|\\bleak.?\\b|\\bleakage|\\bper GDP|\\bper capita")
...
SDG7_a_x <- gsub("\\.\\+", "(?!.*statement)(?!.*granted)(?!.*investigat)(?!.*financial assumption)(?!.*finance corporation)(?!.*electricity trading)", SDG7_a_x) ## to exclude these keywords

SDG7_a_y = c('energy|\\belectric|\\bfuel',
             'research|technolog|infrastructure|hybrid system', 
...
SDG7_general <- gsub("\\.\\+", "(?!.*Renewables segment)", SDG7_general) ## to exclude these keywords
...
SDG8_3_y = c("\\bemploy|\\bjob|\\bwork", 
             "\\bdecent\\b|\\bseemly\\b|respectable|quality|stable|stabili|inclusiv",
...
SDG8_4_x2 = c("resource.?efficien*|efficient resource",
              increase_ls)
...
SDG8_5_x1 = c(paste("\\bfull\\b|\\bdecent\\b|\\bseemly\\b|respectable|productiv", 
                    "inclusi|medical benefit|health benefit|healthcare benefit|insurance benefit", 
                    sep = "|"),
...
### Option 2: to use look around function ----
temp <- SDG8_5_x1
ex_ls <- c('full meeting', 'full potential', 'full Supervisory', 'full implement', 'full year', 'full integration')
...
SDG8_5_x4 = c(equal_ls, 
              "opportunit",
              paste("people|person|\\bemployee|\\bstaff|\\bworker|\\bwork\\b|\\bworking|\\bgender|\\bsex|ethni|\\brace|racial",
                    "\\breligion",
                    disability_ls, 
                    "disadvantaged",
                    female_ls, 
...
SDG8_5_x5 = c("\\bwage|\\bpay|\\bsalary|\\bsalaries|\\bearning|\\bstipend", 
              paste("\\bgap\\b|difference|discrepan|dissimilarit|disproport|divergen|imbalance", discrimination_ls, sep = "|"),
              reduce_ls)
temp <- SDG8_5_x5
SDG8_5_x5 <- lookaround_nearby_n(word_ls1 = temp[1], word_ls2 = temp[2], n = 4, third_AND_string = temp[3])


SDG8_5_x6 = c("Share of|proportion|\\bpercent|discrimination",
              paste(disability_ls, 
...
SDG8_5_x7 = c("unemployment|dismissal",
              paste("\\baddress|tackle|response to|cope.?with|coping with|deal.?with|dealing with|handl|measure.?\\b|\\bbelow\\b|\\blower\\b|\\less\\b", 
                    reduce_ls, sep = "|"))
SDG8_5_x8 = c("employment|\\bhiring|\\bemployee|\\bjob|\\bworker|\\blabor\\b|\\blabour\\b|coverage",
              disability_ls)
...
SDG8_8_x4 <- paste("zero incident",
                   "retirement fund|secure retirement", sep = "|")
...
SDG8_8_x6 <- c(paste("ensure|prioritiz|\\bstimulat|management", increase_ls, sep = "|"),
               "employee benefit|employment benefit|occupational health|occupational safe")
...
SDG9_1   = c("quality|reliab|sustainable|resilien|afford|equitab|inclus",
             infrastructure_ls)
temp <- SDG9_1
### Option 1
...
SDG9_2_y = c('manufactur|\\bindustr', 
             '\\bvalue', 
             'per capita|\\bGDP\\b|gross domestic product')
SDG9_2_z = c('manufactur|\\bindustr', 
             '\\bemployment|\\bhiring|\\bemployee|\\bworker|\\bstaff',
             "Share of|proportion|\\bpercent")
...
SDG9_3_x = c("\\bindustr|enterprise|entrepreneur",
             ...
             "financial service|fiscal|\\bcredit|\\bloan|value chain|\\bbanking|\\binsurance|\\bfund.?\\b|\\bfunding\\b|micro.?credit|micro.?financ")
SDG9_3_y = c("small.?scale industr|micro.?enterprise|small.?sized business", 
             "Share of|proportion|\\bpercent")
SDG9_3_z = c("\\bsmall|\\bmicro.?\\b|starting|startup|kickstart", 
             paste("entrepren", company_ls, sep = "|"),
             paste("Share of|proportion|\\bpercent|financial service|affordable credit", support_ls, sep = "|"))
...
SDG9_5_x = c("technolog|innov|\\binvention|research", 
             paste(increase_ls, 
                   "upgrad|\\bencourag|prioritiz|\\bfurther\\b|\\bfortifie|drive.?\\b|driving|leverag|\\bcontinue|\\binculcat", 
                   "\\bobtain|\\badapt|\\bdevelop",
                   sep = "|"),
             paste("\\bindustr|manufactur|\\boperations|\\bspending|\\bGDP\\b|gross domestic product|\\bproduction|\\bproducts\\b|\\bservice.?\\b", 
                   finance_ls, sep = "|"))
temp <- SDG9_5_x
...
SDG9_5_y = c(paste("\\bresearch\\b|Researcher|scientist|\\bscholar\\b|specialist|\\bexpert.?\\b",
...
SDG9_b_x = c("technolog|innovation|research|medium.?tech|high.?tech|\\bR&D\\b|\\bR & D\\b|\\bR-D\\b|industrial diversification",
...
SDG9_b_y <- c("medium.?tech|high.?tech",
              "value added")
...
SDG10_2_x = c("inclusi",
              paste("empower|\\breform|Prioritiz|\\bstimulat|strengthen|support|\\bcommitment|provid", increase_ls, sep = "|"),
              paste("social|economic|socio.?economic|political|\\bage\\b|\\bsex|\\bgender",
                    female_ls,
                    LGBT_ls,
                    disability_ls,
                    "disadvantaged|\\brace|racial|ethnic|origin|religi|low.?income|demographic", sep = "|"))
...
SDG10_3_x = c("inequalit|discrimin|harass|homophobia|racism|sexism|prejudice",
              reduce_ls)
SDG10_3_y = c("equal opportunit|\\bequality|impartiality|fairness",
...
SDG10_4_x = c("equal|inequalit",
              "\\bpolicy|\\bpolicies|fiscal|economic|financ|\\bwage|income|social|socio.?economic")
SDG10_4_y = "\\bGINI\\b|social protection polic|Labo.?r share of GDP"
...
SDG10_6_x = c("representation|\\bvoic|\\bright|\\bvot|effective|credib|accountable|legitimate|justif|lawful",
...
SDG10_b_x = c("financ|\\bfunding|\\bassistance|budget|\\baid.? to|government aid.?\\b|state aid.?\\b|invest|donor|donat|official flow",
...
SDG11_2 = c("access|availab|affordable",
            "transport|\broad.?\\b|congestion|shipment|\\btransit.?\\b|\\bbus\\b|\\bbuses\\b|\\bbusses\\b|shuttle")
temp <- SDG11_2
w_ex <- c("suppl", "equipment", "Access Bank")
### Option 1
...
SDG11_6_x = c(paste("contaminat|environment|\\bair.?\\b|\\bsmog|\\bhaze|pm2\\.5|pm10|pm 2\\.5|pm 10|particulate matter", 
                    waste_ls, 
                    "spill|\\bsoil\\b|footprint|pollution|pollutant|recycl|circular|toxin|toxic", sep = "|"),
              urban_ls)
SDG11_6_x <- func_AND_plus(SDG11_6_x)
SDG11_6_y = "waste generat|waste manag|waste collected|waste controlled"


SDG11_7_x = c("safe|secure|inclusi|accessible|available|reachable|\\bgreen\\b|\\bpublic|\\bnatur",
              "\\bspace.?\\b|bikeway")
...
SDG12_1_x1 = c("sustainab|\\bgreen\\b|\\bgreener\\b|\\bclean|Responsible|Eco.?Friendly/Environmentally.?Friendly|Recyclable|\\befficien",
...
SDG12_2_w = c("material.?\\b|resource|\\bland\\b|biomass|fossil fuel|Fossil energy|metal ores|industrial mineral", 
              "\\bcoal\\b|\\bpetroleum\\b|natural gas|oil shale|\\bbitumen|\\btar sand|heavy oil",
              "footprint|\\bintensity|\\bflow\\b|\\bflows\\b|consum|depletion|overconsumption",
...
SDG12_4_x = c(paste("manag|\\btreat|agreement|responsi|collected|controlled|handled|removal|disposal|life cycle|safe handl|per capita", 
                    "environmentally.?sound|Responsible|Eco.?Friendly|Environmentally.?Friendly",
                    reduce_ls, sep = '|'),
              paste(waste_ls, 
                    "chemical|contaminat|pesticide|pollut|air emission|\\bpoison|hazard|toxin|toxic", 
...
SDG12_4_z = c("environmental impact|environmental issue|environmental risk",
             paste(reduce_ls, "de.?coupl|informed", 
                   "\\baddress|tackle|response to|cope.?with|coping with|deal.?with|dealing with|handl|measure.?\\b|\\blower\\b|\\less\\b",
                   sep = "|"))
temp <- SDG12_4_z
...
SDG12_5_x = c(paste("recycl|\\bre.?us|re.?utilize|re.?possess|\\bregenerate|circular", 
                    "circulate|circulating|reclaimed|reclamation",
                    "\\breduc", sep = "|"), 
              waste_ls)
temp <- SDG12_5_x
### Option 1
...
SDG12_5_y = c(paste("recycl|\\bre.?us|re.?utilize|re.?possess|\\bregenerate|circular", 
                    "circulate|circulating|reclaimed|reclamation",
                    "\\brepair|\\brefurbish", sep = "|"),
...
SDG12_6_z2 <- c("\\bdisclos|reporting",
                "information|data",
                "emission")
temp       <- SDG12_6_z2
...
SDG13_2_y = c(
  paste("ocean acidification|deforestation|desertificati|animal farming|farming livestock|fertilizer",
        "air pollut|fossil.?fuel|fossil gas|\\bcoal\\b|\\bcoals\\b|petrol|natural gas|traditional energy|Conventional energy|typhoons|hurricane", 
        sep = "|"), 
  reduce_ls)
temp <- SDG13_2_y
...
SDG13_2_z = c(paste(climate_ls, climate_good_ls, sep = "|"), 
              paste("adapt|Mitigation|action|\\bact\\b|legislation|contribut|convention|prepar|fight|\\bcombat|tackle", 
                    "response to|cope.?with|coping with|deal.?with|dealing with|handl|measure",
                    policy_ls, reduce_ls, sep = '|')) 
SDG13_2_w1 <- c(emission_ls, 
                paste("captur|sequest|\\blimit.?\\b|\\bremov|absorb", reduce_ls, sep = "|"))
...
SDG13_2_w2 <- paste0("^(?!.*(?:Power segment|Renewables & Power|wind up|Clean Energy Fuels Corp|\\bltd\\b|Total Solar|alternative approach|Renewables segment)).*", 
                     "(",
...
SDG14_2 = c(paste(ocean_ls, 'coral', sep = "|"),
            "sustainab|resilien|\\brestor|manag|mitigat|health|productiv|habitat|bleach") 
...
SDG14_5 = c(ocean_ls,
            "\\brestor|conserv|protect|safeguard|preserv|\\breduc|\\bplan\\b|\\bplans\\b|planning|mitig|restrict|enforc|monitor|prohibit|reporting")
temp <- SDG14_5
...
SDG15_1_x = c("terrestrial|inland|fresh.?water|water eco.?system|\\bforest|wood.?land|wetland|marsh|mountain|dryland|rain.?forest|agroforest|tundra",
              "conserv|\\brestor|reserv|rehabilitat|mainten|protect|preserv|safeguard|secur|sustain")
SDG15_1_y = c(ecosystem_ls,
              "service|\\bgood.?\\b|\\bproduct.?\\b|\\bsupply|\\bsupplies|contribution",
              "conserv|\\brestor|reserv|rehabilitat|maintain|protect|preserv|safeguard|secur|sustain")
temp <- SDG15_1_y
...
SDG15_2_x = c("\\btree.?plant|plant.? tree|planting tree|deforest|afforest|reforest|silvicultur|mangrove|silviculture|shrub",
              paste("conserv|\\brestor|sustain|manag|mitig|health|resilien|stewardship|certifi|audit|account", increase_ls, sep = "|"))
temp <- SDG15_2_x
### Option 1: use `func_AND_plus` function
...
SDG15_2_y <- c("deforestation|forest product|timber|degraded forest",
...
SDG15_3 = c("degrad|desertif|contamin|pollut|de.?nitrificat|health|nitro|drought|flood", 
            "\\bland|\\bsoil\\b|sediment", 
            paste("\\bcombat|conserv|\\brestor|sustain|manag", reduce_ls, sep = "|"))
...
SDG15_5_y = paste("Protected Area|protection area|conservation area|conservation park",
                  "biodivers|biological diversity|Red List|habitat conversion|habitat degradation|habitat fragmentation|habitat loss", 
                  sep = "|")
SDG15_5_z = c(paste("habitat|\\breserve.?\\b|sanctuar|threaten|endanger|extinct|Refuge\\b|\\bcorridor.?",
                    "\\bdiversity|richness|evenness|abundance|vulnerab|population fragmentation",
                    "extirpate|environment|terrestrial|inland|fresh.?water|forest|grassland|Wetland|Mountain", sep = "|"),
              "species|Wildlife|animal|vertebrate|mammal|amphibian|\\bBird.?|Flora|Fauna")
...
SDG15_b_x = c("forest|biodiversity",
              "conserv|preserv|manag|\\bsustain",
              paste(support_ls, "revenue|\\bvalue|incentiv|\\bspending", sep = '|'))
SDG15_b_y = c("reforestation",
              paste(support_ls, "revenue|\\bvalue|incentiv|\\bspending", sep = '|'))
...
SDG15_general_y = c(ecosystem_ls,
                    "impact|conserv|\\brestor|sustaina|manag|mitig|health|\\bwell\\b|resilien|stewardship|audit|account")
...
SDG16_3_x = c("access", 
              "\\bcode|\\bnorm.?\\b|justice|authorit|\\brule.?\\b|\\blaw|\\blegal|legislation|litigation|conflict resolution|dispute resolution")
temp <- SDG16_3_x
w_ex <- c("Access Bank")
### Option 1
...
SDG16_3_y = c("victim",
              "competent authorit|violence|detain|prison|inmate|disput|officially recognized conflict")
...
SDG16_4_x <- c(paste(illegal_ls, "crime|cybercrime|irregular|prohib|smuggl|unwarranted|stolen|\\bsteal|theft|seized|traced|tracked|conflict|traffic|terroris", sep = "|"),
...
temp <- SDG16_4_x
w_ex <- c('statement', '\\bgranted', 'investigat', 'financial assumption', 
          'finance corporation')
...
SDG16_5_x = c("corrupt|\\bbrib|Tax evasion|extortion", 
              paste("implement|identif|takes into account|aware of|\\bpolicy|\\bpolicies|legislation|\\bregulat|manag|\\brule.?\\b",
                    "\\bagainst\\b|\\bAnti.?\\b|\\bcombat|\\bavoid", 
                    "\\baddress|fight|tackle|response to|cope.?with|coping with|deal.?with|dealing with|handl|measure.?\\b",
                    reduce_ls, sep = "|"))
...
SDG16_6_x = c(paste("institut|\\bgovern|legislat|judicia|public service|civil service|organization.?\\b|association.?\\b",
...
SDG16_6_z = c("peace|inclusive|\\bfair",
              "societ")
temp <- SDG16_6_z
### Option 1
...
SDG16_7_w = c("all members",
              "meeting|discussion",
              "\\binformed|\\bengag|\\bparticipat")



SDG16_8_x = c("institution|global govern|international organization", 
...
SDG16_a_x1 = c("\\bnation|countr|\\bstate.?\\b|domestic|international",
               "institution|cooperat|collaborat|joint effort|partnership",
               "violen|terroris|\\bcrime|criminal|genocid|murder|human traffick|refugee|extremis|insurgen|\\bwar\\b|\\bwars\\b|warfare",
               temp) 
SDG16_a_x2 = c("\\bnation|countr|\\bstate.?\\b|domestic|international",
               "institution|cooperat|collaborat|joint effort|partnership",
               "\\barm|\\bgun|weapon", 
               "conflict", 
               temp) 
SDG16_a_y1 = c("\\bnation|countr|\\bstate.?\\b|domestic",
               "independen",
               "institution|human right|civil right|democracy|treaty|\\bcivil",
               increase_ls)
...
SDG16_a_z  = "Paris Principle|Geneva Convention"


SDG16_b = c("\\blaw|legislat|\\bpolicy|\\bpolicies|human right|protect|safeguard",
            "discrimin|harass")
...
SDG16_general_x1 <- 
  paste(LGBT_ls,
        "\\bDEI\\b|\\bDEIJ\\b|Social Justice|inclusive societ|diversity and inclusion",
        sep = "|")
...
SDG16_general_x3 <- c("\\bdata|\\binformation|\\bcyber\\b|\\bcloud\\b|\\bInternet\\b|\\bnetwork\\b|\\bmobile\\b",
                      "privacy|security|protection|sensitive|confidential|\\battack|\\bhack|\\bcrime|\\bterroris|warfare")
...
SDG17_3_x = c("financial resource|\\bfund.?\\b|\\bfunding\\b|financial assist|financial aid|\\baid.? to|government aid.?\\b|state aid.?\\b|invest|\\bdonat|official flow", 
              "\\bto\\b|\\bfor\\b",
              developing_country_ls)
temp <- SDG17_3_x
w_ex <- c('statement', '\\bgrant.?\\b', 'subsid', 'budget', 'investigat', 'financial assumption', 
          'finance corporation', 'Principles for Responsible Investment')
### Option 1
...
SDG17_9_y = c("financ|\\btechnical|technolog",
              "assistance|\\baid\\b", 
              developing_country_ls)
...
SDG17_9_z = c("North.?South|South.?South|triangular", 
              "cooperat|collaborat|joint effort|partnership",
              developing_country_ls)
...
SDG17_general_x = c("sustainab|global",
                    "partner|cooperat|collaborat|joint effort|Alliance|coordinat|\\bstabil|stabl")
SDG17_general_y = c("partner|cooperat|collaborat|joint effort|Alliance",
                    "between",
                    developing_country_ls)
